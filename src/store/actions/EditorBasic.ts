...
export const openUpdateEditor = (
  state: EditorReducerType,
  { editors }: { editors: Array<Editor> }
) => {
  return {
    ...state,
    editors,
...
export const addEditorWithPosition = (
  state: EditorReducerType,
  { index }: { index: number }
) => {
 ...
 */
export const removeEditorByToolbar = (
  state: EditorReducerType,
  { e }: { e: React.KeyboardEvent }
) => {
...
export const removeEditorByReactElement = (
  state: EditorReducerType,
  { index }: { index: number }
) => {
  const editors = [...state.editors];
...
export const moveEditorUpByReactElement = (
  state: EditorReducerType,
  { index }: { index: number }
) => {
  const editors = [...state.editors];
...
export const moveEditorDownByReactElement = (
  state: EditorReducerType,
  { index }: { index: number }
) => {
  const editors = [...state.editors];
